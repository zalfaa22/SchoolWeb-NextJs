    ...
    <>
      <div className="bg-white">
        ...
        <div class="my-16 ml-7 lg:ml-16 ">
          <h2 class="text-blue-400 text-base lg:text-2xl font-medium font-Poppins">
            Profil Singkat
          </h2>
          ...
          <p class="text-neutral-700 lg:text-2xl font-medium font-Poppins pr-10">
        ...
        <div class="py-6 mt-28 text-center text-gray-800">
          <h2 class="text-purple-500 text-base lg:text-2xl font-normal font-Poppins mb-3">
            Kenapa Memilih Kami
          </h2>
        ...
        <div class=" lg:w-[1263px] h-[1400px] lg:h-[650px] pt-5 bg-indigo-50 ">
          <div class=" lg:mt-16 mb-5 ml-7 lg:ml-28 ">
        ...
        <div class="py-6 lg:mt-28 text-center text-gray-800">
          ...
          <div class="w-[250px] lg:w-[1100px]  bg-blue-400 bg-opacity-25 rounded-3xl justify-center items-center inline-flex">
