    ...
    <div class="container px-5 lg:px-28 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <span class="inline-block p-2 lg:p-3 bg-violet-500 rounded-full ">
                    <img src="book.svg" class="w-10 h-10 p-2 lg:w-12 lg:h-12 lg:p-2"/>
                </span>

                <h2 class="mt-4 text-xl lg:text-2xl font-semibold text-gray-800 lg:pr-20">Menggunakan
                  Kurikulum Terbaru</h2>

                <p class="mt-2 text-neutral-400 text-base lg:text-lg font-Poppins lg:mr-2 tracking-tight">Sekolah kami menerapkan kurikulum terbaru saat proses belajar
